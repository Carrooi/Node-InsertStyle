...
'src/Style.coffee': function(exports, __require, module) {
var require = function(name) {return __require(name, 'src/Style.coffee');};
var __filename = 'src/Style.coffee';
var __dirname = 'src';
var process = {cwd: function() {return '/';}, argv: ['node', 'src/Style.coffee'], env: {}};
(function() {
  var Style, style;
...
'insert-style': 'src/Style'
});

require._setMeta({"insert-style":{"base":"","path":"lib/Style.js"}});
